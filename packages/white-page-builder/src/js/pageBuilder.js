...
class PageBuilder {
  ...
  _createCol (row, exists = false, inner = '') {
    ...
    const content = exists && row.querySelector('div.' + this.className + '-content') ? row.querySelector('div.' + this.className + '-content') : this._createEl('div', { class: this.className + '-content gui' }, inner)
